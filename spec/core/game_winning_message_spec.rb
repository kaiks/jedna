...
RSpec.describe "Jedna::Game winning message" do
  ...
  describe "casual game winning message" do
    ...
    before do
      ...
      bob.hand << [
        ...
        Jedna::Card.new(:yellow, 8),     # 8 points
        Jedna::Card.new(:red, '+2'),     # 20 points
        Jedna::Card.new(:blue, 6)        # 6 points
      ] # Total: 63 points
  ...
  describe "regular game winning message with database stats" do
    ...
    let(:game) { Jedna::Game.new('TestCreator', 0, test_notifier, nil, mock_repository) }
